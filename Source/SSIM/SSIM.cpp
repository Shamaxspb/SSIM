...
DEFINE_LOG_CATEGORY(LogSSIMInputValidation);
DEFINE_LOG_CATEGORY(LogSSIMStatsCalculation);
DEFINE_LOG_CATEGORY(LogSSIMAnimation);
DEFINE_LOG_CATEGORY(LogSSIMGameplayAbilities);
DEFINE_LOG_CATEGORY(LogSSIMProgression);
DEFINE_LOG_CATEGORY(LogSSIMLevelTransition);

DEFINE_LOG_CATEGORY(LogSSIMDebug);
